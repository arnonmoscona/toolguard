...
:mod:`toolguard.foundation.patterns`. Includes a bare allow/deny check (:func:`check_permission`),
...
:class:`~toolguard.decision_model.vocabulary.CommandSpellings` built by
...
from toolguard.decision_model.vocabulary import CommandSpellings, LevelMatch
from toolguard.foundation.constants import DECISION_ALLOW, DECISION_ASK, DECISION_DENY
from toolguard.foundation.patterns import parse_pattern, match_pattern, PatternType
...
def normalize_path_in_command(
    ...
    Delegates to :func:`~toolguard.foundation.normalization.normalize_command`, then also adds a
    ...
    Args:
        ...
        resolve_symlinks: Forwarded to
            :func:`~toolguard.foundation.normalization.normalize_command`.
...
def match_command(
    ...
    *also_spelled*, and against the tilde-expanded form of each -- so a rule naming a
    ...
    handling and match the spellings directly via :func:`~toolguard.foundation.patterns.match_pattern`.
    ...
    Args:
        ...
        also_spelled: Further spellings of the same command to match -- whichever
            side of a :class:`~toolguard.decision_model.vocabulary.CommandSpellings` suits
    ...
    Returns:
        ...
        *patterns*, extended-syntax prefix included -- not what
        :func:`~toolguard.foundation.patterns.parse_pattern` would extract.
        :func:`~toolguard.decision_model.vocabulary.provenance_for_pattern` relies on this identity: it
...
def check_hard_deny(
    ...
    *,
    ...
    Returns:
        A :class:`~toolguard.decision_model.vocabulary.LevelMatch` with ``decision='deny'``
...
def decide_command_at_level_detailed(
    ...
    *,
    ...
    :class:`~toolguard.decision_model.vocabulary.LevelMatch`. Otherwise the allow and ask lists are
    ...
    Returns:
        A :class:`~toolguard.decision_model.vocabulary.LevelMatch` when this level matches,
