...
couple of low-level values used by :mod:`toolguard.install._git` and its callers. A
...
from toolguard.integration.claude_code_contract import (
    COMMAND_PAYLOAD_KEY as _COMMAND_PAYLOAD_KEY,
)
from toolguard.foundation.tool_spec import BUILTIN_TOOLS as _BUILTIN_TOOLS
from toolguard.foundation.tool_spec import FILE_KIND_TOOLS as _FILE_KIND_TOOLS
...
#: written by :mod:`toolguard.observability.log_writer`.
STATUS_ASK = "ASK"
...
#: :func:`toolguard.install._git.run_git` -- guards against a hang or an
...
#: :class:`~toolguard.foundation.tool_spec.ToolSpec` (e.g. an unrecognized MCP tool
