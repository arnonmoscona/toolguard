...
def issue_takeover_warning(
    ...
    Reported at :data:`~toolguard.observability.error_reporter.SEVERITY_NOTICE`: routine,
    expected on every call while takeover is active, never logged, never
    reaching Claude (see :mod:`toolguard.observability.error_reporter`'s ``_ROUTING``
