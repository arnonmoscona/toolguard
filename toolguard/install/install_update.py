...
:func:`~toolguard.install._git.run_git`'s timeout, and the two ``ls-remote`` calls
...
from toolguard.foundation.constants import DIST_NAME as _DEFAULT_DIST_NAME
...
def distribution_name() -> str:
    ...
    :data:`~toolguard.foundation.constants.DIST_NAME` when it cannot be read.
    """
    try:
...
def check(quiet: bool, do_upgrade: bool) -> int:
    """
