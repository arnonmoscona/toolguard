...
``detect_foreign_inline_code`` (in :mod:`toolguard.parser.command_extractor`)
...
class TestForeignInlineCodeBaseline(unittest.TestCase):
    ...
    def test_python_dash_c_detected(self):
        ...
        When detect_foreign_inline_code inspects it
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('python -c "print(1)"'))
    ...
    def test_python3_dash_c_detected(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('python3 -c "print(1)"'))
    ...
    def test_node_dash_e_detected(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('node -e "console.log(1)"'))
    ...
    def test_perl_dash_e_detected(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('perl -e "print 1"'))
    ...
    def test_ruby_dash_e_detected(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('ruby -e "puts 1"'))
    ...
    def test_php_dash_r_detected(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('php -r "echo 1;"'))
    ...
    def test_rscript_dash_e_detected(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('Rscript -e "print(1)"'))
    ...
    def test_uv_run_python_dash_c_detected(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('uv run python -c "print(1)"'))
    ...
    def test_absolute_path_to_interpreter_detected(self):
        ...
        """
        self.assertTrue(detect_foreign_inline_code('/usr/bin/python3 -c "import os"'))
    ...
    def test_versioned_interpreter_detected(self):
        ...
        """
        self.assertTrue(detect_foreign_inline_code('python3.13 -c "import os"'))
    ...
    def test_python_script_file_not_flagged(self):
        ...
        """
        self.assertFalse(detect_foreign_inline_code("python script.py"))
    ...
    def test_python_script_with_dash_c_as_script_arg_not_flagged(self):
        ...
        Then it is NOT flagged as inline code (False)
        """
        self.assertFalse(detect_foreign_inline_code("python script.py -c foo"))
    ...
    def test_python_dash_m_module_with_dash_c_arg_not_flagged(self):
        ...
        Then it is NOT flagged as inline code (False)
        """
        self.assertFalse(detect_foreign_inline_code("python -m mymod -c foo"))
    ...
    def test_ls_dash_c_not_a_foreign_executor(self):
        ...
        Then it is NOT flagged as inline code (False)
        """
        self.assertFalse(detect_foreign_inline_code("ls -c"))
    ...
    def test_git_commit_message_not_flagged(self):
        ...
        Then it is NOT flagged as inline code (False)
        """
        self.assertFalse(detect_foreign_inline_code('git commit -m "x"'))
    ...
    def test_name_merely_starting_with_an_interpreter_name_not_flagged(self):
        ...
        """
        self.assertFalse(detect_foreign_inline_code("pythonic -c foo"))
    ...
    def test_inline_flag_of_a_different_executor_not_flagged(self):
        ...
        """
        self.assertFalse(detect_foreign_inline_code('python -e "import os"'))
...
class TestForeignInlineCodeBypasses(unittest.TestCase):
    ...
    def test_python_intervening_dash_u_flag(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('python -u -c "import os"'))
    ...
    def test_python_intervening_dash_capital_b_flag(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('python -B -c "import os"'))
    ...
    def test_python_intervening_dash_capital_i_flag(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('python -I -c "import os"'))
    ...
    def test_python3_intervening_dash_capital_o_flag(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('python3 -O -c "import os"'))
    ...
    def test_perl_intervening_dash_w_flag(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('perl -w -e "print 1"'))
    ...
    def test_ruby_intervening_dash_w_flag(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('ruby -w -e "puts 1"'))
    ...
    def test_python_attached_flag_no_space(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code("python -cimport os"))
    ...
    def test_python_attached_flag_with_quote(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code("python -c'import os'"))
    ...
    def test_python_combined_short_flags(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('python -uc "import os"'))
    ...
    def test_perl_combined_short_flags(self):
        ...
        """
        self.assertTrue(detect_foreign_inline_code("perl -we 'print 1'"))
    ...
    def test_uv_run_python_intervening_flag(self):
        ...
        Then it is recognised as foreign inline code (True)
        """
        self.assertTrue(detect_foreign_inline_code('uv run python -u -c "import os"'))
...
class TestForeignInlineCodeMissedForms(unittest.TestCase):
    ...
    def test_deep_short_flag_bundle(self):
        ...
        """
        self.assertTrue(detect_foreign_inline_code('python -uBIc "import os"'))
    ...
    def test_uppercase_inline_flag(self):
        ...
        """
        self.assertTrue(detect_foreign_inline_code("perl -E 'say 1'"))
    ...
    def test_long_form_inline_flag(self):
        ...
        """
        self.assertTrue(detect_foreign_inline_code('node --eval "console.log(1)"'))
    ...
    def test_flag_taking_a_separate_value_token(self):
        ...
        """
        self.assertTrue(detect_foreign_inline_code('python -X dev -c "import os"'))
    ...
    def test_awk_inline_program(self):
        ...
        """
        self.assertTrue(detect_foreign_inline_code("awk '{print $1}' f"))
...
class TestForeignInlineCodeOverDetection(unittest.TestCase):
    ...
    def test_interpreter_name_as_an_argument_not_flagged(self):
        ...
        """
        self.assertFalse(detect_foreign_inline_code("grep python -c file"))
    ...
    def test_wrapper_before_the_interpreter_still_flagged(self):
        ...
        Then it is recognised (True)
        """
        self.assertTrue(detect_foreign_inline_code('timeout 5 python -c "import os"'))
    ...
    def test_env_assignment_before_the_interpreter_still_flagged(self):
        ...
        Then it is recognised (True)
        """
        self.assertTrue(detect_foreign_inline_code('env X=1 python -c "import os"'))
...
class TestInlineCodeInsideSubstitution(unittest.TestCase):
    ...
    :func:`~toolguard.engine.compound.decompose` via ``extract_commands``, which
