...
title: 77-briefing
type: note
permalink: toolguard/too-45/reports/surprise/77-briefing
---
...
- `test/unit/test_hook.py` (3426 lines) — Unit tests for toolguard.hook: the PreToolUse entry point for Bash and file-path tools.
